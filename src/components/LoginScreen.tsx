...
import { Gem, ShieldCheck, Key, AlertCircle, CheckCircle, Lock } from 'lucide-react';
        ...
        <div style={{ padding: '28px 32px 36px' }}>
          ...
          >
            <button
              ...
              style={{
                ...
                borderRadius: '8px',
                border: 'none',
                background: activeTab === 'google' ? 'rgba(212, 175, 55, 0.18)' : 'transparent',
            ...
            <button
              ...
              style={{
                ...
                borderRadius: '8px',
                border: 'none',
                background: activeTab === 'password' ? 'rgba(212, 175, 55, 0.18)' : 'transparent',
          ...
          {activeTab === 'google' ? (
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '20px' }}>
              ...
              {/* Instant Developer / Main Admin Login Shortcut */}
              <div style={{ width: '100%' }}>
                <div
                  style={{
                    display: 'flex',
                ...
                >
                  ...
                  <span>OR DIRECT SUPER ADMIN ACCESS</span>
                  <div style={{ flex: 1, height: '1px', background: 'rgba(255, 255, 255, 0.08)' }} />
                </div>
                ...
                >
                  ...
                  <span>Sign in as Admin (hasan.laiq@gmail.com)</span>
                </button>
              </div>
            </div>
          ) : (
