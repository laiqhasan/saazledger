...
CREATE TABLE IF NOT EXISTS media_assets (
  ...
  file_role TEXT DEFAULT 'gallery',
  source_type TEXT DEFAULT 'original_upload',
  quality_score REAL DEFAULT 80.0,
  blur_score REAL DEFAULT 0.0,
  cropping_safety_score REAL DEFAULT 100.0,
  duplicate_group TEXT,
  generation_prompt TEXT,
  generation_template TEXT,
  generated_from_media_id TEXT,
  shopify_upload_status TEXT DEFAULT 'not_started',
  shopify_file_id TEXT,
  shopify_media_id TEXT,
  shopify_position INTEGER,
  selection_status TEXT DEFAULT 'candidate',
  alt_text TEXT,
  is_deleted INTEGER DEFAULT 0,
  deleted_at DATETIME,
  deleted_by TEXT,
...
CREATE TABLE IF NOT EXISTS product_media_links (
  ...
  gallery_position INTEGER DEFAULT 0,
...
-- 28. Product Physical Measurements (Extracted from ruler/scale imagery)
